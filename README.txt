...
The C_Code is a dump of Project Euler problems that I had originally solved in C and wanted to be able to reference while developing my python code.  They are fairly self contained source files, but may require some massaging to build properly. 
